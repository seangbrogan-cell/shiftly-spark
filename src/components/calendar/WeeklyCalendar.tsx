      ...
      {isLoading ? (
        ...
        <>
          <div className="rounded-lg border border-border bg-card overflow-x-auto">
            {/* Day Headers */}
            <div className="grid grid-cols-[120px_repeat(7,1fr)_60px] border-b border-border sticky top-0 bg-card z-10">
            ...
            {[...employees].sort((a, b) => {
              ...
              <div key={emp.id} className="grid grid-cols-[120px_repeat(7,1fr)_60px]">
                {/* Employee Name Cell */}
            ...
            <div className="grid grid-cols-[120px_repeat(7,1fr)_60px] border-t border-border bg-muted/30">
